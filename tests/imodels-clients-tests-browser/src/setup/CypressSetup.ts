...
export async function setupIntegrationTests(
  ...
  config.env[FrontendTestEnvVariableKeys.admin1AuthorizationInfo] =
  ...
  config.env[FrontendTestEnvVariableKeys.testIModelForReadId] =
    testIModelForRead.id;
