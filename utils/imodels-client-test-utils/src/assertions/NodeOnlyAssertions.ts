...
import {
  BaselineFile,
  BaselineFileState,
  ChangesetGroupPropertiesForCreate,
...
} from "./BrowserFriendlyAssertions";
import {
  assertChangesetCallbacks,
  assertChangesetGroupCallbacks,
  assertMinimalChangesetCallbacks,
...
export async function assertChangeset(params: {
  ...
  assertSynchronizationInfo({
    ...
    expectedSynchronizationInfo:
      params.expectedChangesetProperties.synchronizationInfo,
...
export async function assertChangesetGroup(params: {
  ...
  expectedChangesetGroupProperties: ChangesetGroupPropertiesForCreate &
    Partial<ChangesetGroupPropertiesForUpdate>;
}): Promise<void> {
