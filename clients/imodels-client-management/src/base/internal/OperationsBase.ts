...
import { AuthorizationParam, BinaryContentType, ContentType, Dictionary, HeaderFactories, HeadersParam, HttpResponse, IModelsOriginalError, PreferReturn, RestClient, SupportedGetResponseTypes } from "../types/index.js";

import { CollectionResponse } from "./ApiResponseInterfaces.js";
import { IModelsErrorBaseImpl, ResponseInfo } from "./IModelsErrorParser.js";
import { EntityCollectionPage } from "./UtilityTypes.js";

type CommonRequestParams = AuthorizationParam & HeadersParam;
type ParseErrorFunc = (response: ResponseInfo, originalError: IModelsOriginalError) => Error;
