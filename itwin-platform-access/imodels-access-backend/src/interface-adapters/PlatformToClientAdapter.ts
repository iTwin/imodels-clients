...
import { Authorization, AuthorizationCallback, ChangesetPropertiesForCreate, ChangesetIdOrIndex as ClientChangesetIdOrIndex, ContainingChanges, LockLevel, LockedObjects, iModelPropertiesForCreate } from "@itwin/imodels-client-authoring";
...
export class PlatformToClientAdapter {
  ...
  public static toiModelPropertiesForCreate(createNewiModelProps: CreateNewIModelProps): iModelPropertiesForCreate {
    return {
